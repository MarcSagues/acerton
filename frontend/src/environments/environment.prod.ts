export const environment = {
  ...
  admob: {
    // rewardedAdUnitId: id de PRUEBA oficial de Google, no uno real de esta
    // cuenta de AdMob todavia — sustituir por la unidad de tipo "Recompensado"
    // real (creada en el panel de AdMob) antes de dar esto por lanzado de
    // verdad, o los "anuncios" del comodin gratis nunca generaran ingresos.
    android: {
